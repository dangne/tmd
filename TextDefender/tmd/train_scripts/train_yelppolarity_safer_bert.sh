...
#SBATCH --job-name=train_yelppolarity_safer_bert
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
srun --container-image=/lustre/scratch/client/vinai/users/dangnm12/setup/docker_images/dc-miniconda3-py:38-4.10.3-cuda11.4.2-cudnn8-ubuntu20.04.sqsh \
     ...
     python main.py --mode=train --model_type=bert --model_name_or_path=/root/manifold_defense/models/bert-base-uncased --dataset_name=yelppolarity --dataset_path=/root/TextDefender/dataset/yelppolarity --training_type=safer --max_seq_len=256 --do_lower_case=True --safer-perturbation-set=/root/TextDefender/cache/embed/yelppolarity/perturbation_constraint_pca0.8_100.pkl
     "
