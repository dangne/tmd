...
#SBATCH --job-name=train_sst2_ascc_albert
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
srun --container-image=/lustre/scratch/client/vinai/users/dangnm12/setup/docker_images/dc-miniconda3-py:38-4.10.3-cuda11.4.2-cudnn8-ubuntu20.04.sqsh \
     ...
     python main.py --mode=train --model_type=albert --model_name_or_path=/root/manifold_defense/models/albert-base-v2 --dataset_name=sst2 --dataset_path=/root/TextDefender/dataset/sst2 --training_type=ascc --max_seq_len=64 --do_lower_case=True
     "
